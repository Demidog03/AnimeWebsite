...
<center><div style="font-size: 40px; position: relative;">Search for an anime.</div></center>

            <center><div class="searchInput"><form  action="search.php" method="POST">
                <input type="text" name="search" placeholder="Search">
                <button type="submit" name="submit-search">Search</button>
            </form></div></center>

            <center><div style="color: black; font-size: 25px;">All anime: </div></center>
            <div class="anime-container">
                <?php
                    ...
                    if($queryResults > 0){
                        while($row = mysqli_fetch_assoc($result)){
                            echo "<center><div style='border: 5px solid;border-color: black; width: 800px; position: relative; left: 80px;'>
                            <br>
                                <center><a href='http://localhost/login/pages/".$row['a_id'].".php'>
                    <div style='font-size: 35px;'>".$row['a_title']."</div></a></center>
                                <p style='width: 600px;'class='search_disc'>".$row['a_disc']."</p>
                                <img style='width: 400px;' src=".$row['a_image']."/>
                                <p>".$row['a_author']."</p>
                                <p>".$row['a_date']."</p>
                                </div></center>";
                        }
